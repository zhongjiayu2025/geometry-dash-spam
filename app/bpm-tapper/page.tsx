...
export const metadata: Metadata = {
    title: "BPM Tapper | Rhythm & Beat Finder for Geometry Dash",
    description: "Tap to the beat to find the BPM of any song. Practice your rhythm skills for fast-paced Geometry Dash levels.",
};
        ...
        <>
            <div className="mb-8 md:mb-12 text-center animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <p className="text-slate-500 max-w-2xl mx-auto text-sm md:text-base">
                    Find the beats per minute (BPM) of any song. Tap to the rhythm.
                </p>
            </div>
            <BpmTapper />
        </>
