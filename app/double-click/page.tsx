...
export const metadata: Metadata = {
    title: "Double Click Test | Check Mouse Debounce & Ghost Clicks",
    description: "Ensure your gaming mouse isn't double clicking. Test for hardware bounce issues and measure time between clicks.",
};
        ...
        <>
            <div className="mb-8 md:mb-12 text-center animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <p className="text-slate-500 max-w-2xl mx-auto text-sm md:text-base">
                    Check if your mouse is suffering from bounce issues by measuring the delay between clicks.
                </p>
            </div>
            <DoubleClickTest />
        </>
