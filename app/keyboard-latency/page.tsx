...
export const metadata: Metadata = {
    title: "Keyboard Latency Test | Key Scan Rate Benchmark",
    description: "Measure your keyboard's raw scan rate. See how fast you can trigger a keydown to keyup state to test switch latency.",
};
        ...
        <>
            <div className="mb-8 md:mb-12 text-center animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <p className="text-slate-500 max-w-2xl mx-auto text-sm md:text-base">
                    Find out how fast your keyboard registers a single tap (keydown to keyup). Lower is better.
                </p>
            </div>
            <KeyboardLatencyTest />
        </>
